...
class DetoxManager implements WebSocketClient.ActionHandler {
    ...
    private static final ThreadFactory threadFactory = new ThreadFactory() {
        ...
        public Thread newThread(@Nonnull Runnable r) {
            ...
            Log.i(LOG_TAG, "Detox thread " + name + " has been created");
            return new Thread(r, name);
        }
    };

    private static final Integer MAX_CONCURRENT_JOBS = 3;
    private static final LaunchArgs launchArgs = new LaunchArgs();

    private String detoxServerUrl;
    private String detoxSessionId;

    private ExecutorService executor = Executors.newFixedThreadPool(MAX_CONCURRENT_JOBS, threadFactory);
    private WebSocketClient wsClient = new WebSocketClient(this);;
